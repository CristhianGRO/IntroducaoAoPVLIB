#INTRODUÇÃO AO PVLIB - Exemplo 3 - Simulação de Saturação do Inversor.
#==========================================================================================
...
#Definindo o sistema PV, com as informaçães de ângulo, ajuste de temperatura, modelo de módulo e de inversor. Define-se 3 módulos conectados em série em uma string, de forma a gerar a saturação do inversor.
...
times = pd.date_range(start="2019-02-01",end="2019-02-02",
                    freq="1h",
                    tz=location.tz)
...
#Plotagem da potência CA gerada.
plt.style.use('bmh')
plt.plot(modelChain.results.ac,label='Saturação de Inversor')
plt.title('Potencia AC gerada por 3 módulos conectados ao inversor')
plt.xlabel('Horas')
